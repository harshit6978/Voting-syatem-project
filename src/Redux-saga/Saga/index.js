...
import { delete_user_saga, get_user_saga } from "./Root/rootUser";
...
export function* rootSaga() {
    ...
    get_Party_saga(), post_Party_saga(), delete_Party_saga(),get_user_saga(),delete_user_saga(),get_connect_saga(),post_connect_saga(),delete_connect_saga()])
}